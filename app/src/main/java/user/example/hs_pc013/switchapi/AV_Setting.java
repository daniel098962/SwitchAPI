...
public class AV_Setting extends ClientCode {

    Intent intentSet;
    byte buffAV[] = new byte[4096];
    String feedbackAV[];
    RadioGroup rgST;
    RadioButton btnST1,btnST2,btnST3,btnST4;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_av__setting);
...
/*
        ...
        String Edid = bundle.getString("EDID");
...
*/
    ...
    public void VideoType()
    {
        ...
        {
            Toast.makeText(AV_Setting.this,e.getMessage(),Toast.LENGTH_SHORT).show();
        }
