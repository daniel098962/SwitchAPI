...
public class HX_2562 extends ClientCode {

    ImageButton btnC;
    ImageButton btnF;
    ImageButton btnS;
    RadioGroup rgAV,rgIN,rgOP,rgIN2,rgME,rgALL;
    RadioButton btnA1;
    RadioButton btnA2;
    RadioButton btnIN1;
    RadioButton btnIN2;
    ...
    String AorV = "";
    int InpuT=1,OutpuT;
    String inputString,inputString1,inputString2,inputString3,inputString4,inputString5,inputString6;
    byte Inp=0x01,OuT;
    String CrcS,CrcH;
    int CrcI;
    int xorCRC;
    ...
    boolean EDID,SL;
    int MeTol,MeNum[];
    String getIP1,getIP2,getIP3,getIP4,getIP5,getIP6;
    String getOUT1,getOUT2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hx_2562);
...
*/
        ...
        rgIN2.getLayoutParams().width=(int)((vWidth-214.2)/2);
        rgIN.getLayoutParams().width = (int)(vWidth-214.2);
        rgALL.getLayoutParams().width=(int)((vWidth-214.2)/2);
        rgOP.getLayoutParams().width = (int)((vWidth-214.2)/2);
        ...
        public void onClick(View v)
        {
            ...
            switch (v.getId())
            {
                case R.id.btnLink:
                {
                    ...
                    change.setClass(HX_2562.this,ClientCode.class);
                ...
                case R.id.btnS:
                {
                    ...
                    change.setClass(HX_2562.this,SettingConfig.class);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public void onCheckedChanged(RadioGroup radioGroup,int checkedId)
        {
            switch (checkedId)
            {
                ...
                case R.id.btnAV2:
                {
                    ...
                    change.setClass(HX_2562.this, AV_Setting.class);
                    startActivity(change);
                ...
                case R.id.btnOU1:
                {
                    ...
                    {
                        Toast.makeText(HX_2562.this, "You choose the wrong button  " + AorV + " please change", Toast.LENGTH_LONG).show();
                    }
                    rgOP.clearCheck();
                    break;
                }
                ...
                case R.id.btnME1:
                {
                    ...
                    SL = true;
                    change.setClass(HX_2562.this, SaveLoad.class);
    ...
    public void runSocket()
    {
        ...
        try
        {
            if (m_socket != null)//連線成功才繼續往下執行
            {
                ...
                Toast toast = Toast.makeText(HX_2562.this, "連線成功", Toast.LENGTH_SHORT);
                //toast.show();
        ...
        {
            Toast toast2 = Toast.makeText(HX_2562.this,e.getMessage(),Toast.LENGTH_SHORT);
            toast2.show();
    ...
    public void Information()
    {
        ...
        Mation.setClass(HX_2562.this,Information.class);
    ...
    public void buttonSetText()
    {
        ...
        //Toast.makeText(HX_2562.this,str1+" "+str2,Toast.LENGTH_SHORT).show();
    }
