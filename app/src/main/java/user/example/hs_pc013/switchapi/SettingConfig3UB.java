...
public class SettingConfig3UB extends ClientCode {

    EditText InputConfig1,InputConfig2,InputConfig3,InputConfig4,InputConfig5,InputConfig6,InputConfig7,InputConfig8,
            OutputConfig1,OutputConfig2,OutputConfig3,OutputConfig4,OutputConfig5,OutputConfig6,OutputConfig7,OutputConfig8,IpConfig;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_config3_ub);
...
//                final ProgressDialog dialog = ProgressDialog.show(SettingConfig3UB.this,
        ...
        public void onClick(View v)
        {
            switch (v.getId())
            {
                case R.id.btnConSaveRe :
                {
                    ...
                    {
                        Toast.makeText(SettingConfig3UB.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    }

                    ipFinal3UB = IpConfig.getText().toString();
                    SharedPreferences sharedIP = getSharedPreferences("SharedIP", MODE_PRIVATE);
                    sharedIP.edit()
                            .putString("shIP",ipFinal3UB)
                            .commit();
                    ...
                    try {
                        ...
                        m_socket.connect(new InetSocketAddress(ipFinal3UB, 5000), 5000);
                    }
                    catch (IOException e)
                    {
                        Toast.makeText(SettingConfig3UB.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                ...
                case R.id.btnConModify :
                {
                    ...
                    SharedPreferences shared = getSharedPreferences("Config3UB", MODE_PRIVATE);
                    shared.edit()
                            .putString("IP1",ip1)
                            .putString("IP2",ip2)
                            .putString("IP3",ip3)
