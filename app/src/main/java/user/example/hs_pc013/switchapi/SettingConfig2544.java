...
import static user.example.hs_pc013.switchapi.ClientCode.ipFinal2544;
...
public class SettingConfig2544 extends AppCompatActivity {

    EditText InputConfig1,InputConfig2,InputConfig3,InputConfig4,OutputConfig1,OutputConfig2,OutputConfig3,OutputConfig4,IpConfig;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_config2544);
        ...
        public void onClick(View v)
        {
            switch (v.getId())
            {
                case R.id.btnConSaveRe :
                {
                    ...
                    {
                        Toast.makeText(SettingConfig2544.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    }

                    ipFinal2544 = IpConfig.getText().toString();
                    SharedPreferences sharedIP = getSharedPreferences("SharedIP", MODE_PRIVATE);
                    sharedIP.edit()
                            .putString("shIP",ipFinal2544)
                            .commit();
                    ...
                    try {
                        ...
                        m_socket.connect(new InetSocketAddress(ipFinal2544, 5000), 5000);
                    }
                    catch (IOException e)
                    {
                        Toast.makeText(SettingConfig2544.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                ...
                {
                    String ip1,ip2,ip3,ip4,out1,out2,out3,out4;
                    ...
                    SharedPreferences shared = getSharedPreferences("Config2544", MODE_PRIVATE);
                    shared.edit()
                            .putString("IP1",ip1)
                            .putString("IP2",ip2)
                            .putString("IP3",ip3)
